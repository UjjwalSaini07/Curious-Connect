// Todo: Changes Done from Curious
...
// Todo: Last Commit After i fall into Crack and Code Rubered
    ...
    <div className='bg-black flex md:flex-wrap lg:flex-nowrap gap-5 items-start px-7 pt-10 pb-6 max-md:flex-wrap max-md:px-5'>
        ...
        <div className='flex gap-4 text-xl font-bold tracking-wide text-center text-white'>
          ...
          >
            <img
              ...
              style={{
                ...styles.logoImage,
                ...(hoveredElement === 'logo' ? styles.logoImageHover : {}),
              }}
            />
          </Link>
          <div className='flex-auto lg:pr-52 my-auto pr-[19vw] md:pr-52'>
            <Link
              ...
              style={{
                ...styles.footerTitle,
                ...(hoveredElement === 'title' ? styles.footerTitleHover : {}),
              }}
      ...
      <div className='flex-auto mt-3.5 lg:pl-8 text-[16px] font-normal  tracking-wide leading-10 text-white'>
        ...
        <span
          style={{
            ...styles.linkItem,
            ...(hoveredElement === 'webinars' ? styles.linkItemHover : {}),
          }}
          onMouseEnter={() => setHoveredElement('webinars')}
          onMouseLeave={() => setHoveredElement(null)}
        >
          Webinars
        </span>
        ...
        <span
          style={{
            ...styles.linkItem,
            ...(hoveredElement === 'events' ? styles.linkItemHover : {}),
          }}
          onMouseEnter={() => setHoveredElement('events')}
          onMouseLeave={() => setHoveredElement(null)}
        >
          Events
        </span>
      ...
      <div className='flex flex-col mt-3 font-normal'>
        ...
        {/* //todo: Svg Icons in this Section */}
        
        {/* //todo: Svg Icon of Discord */}
        <div className='flex self-center rounded-full bg-[#42454A] h-[50px] w-[50px] max-w-full'>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 512"
            className='p-2.5 bounce'
          >
            <path
              fill='#ffffff'
              d="M524.5 69.8a1.5 1.5 0 0 0 -.8-.7A485.1 485.1 0 0 0 404.1 32a1.8 1.8 0 0 0 -1.9 .9 337.5 337.5 0 0 0 -14.9 30.6 447.8 447.8 0 0 0 -134.4 0 309.5 309.5 0 0 0 -15.1-30.6 1.9 1.9 0 0 0 -1.9-.9A483.7 483.7 0 0 0 116.1 69.1a1.7 1.7 0 0 0 -.8 .7C39.1 183.7 18.2 294.7 28.4 404.4a2 2 0 0 0 .8 1.4A487.7 487.7 0 0 0 176 479.9a1.9 1.9 0 0 0 2.1-.7A348.2 348.2 0 0 0 208.1 430.4a1.9 1.9 0 0 0 -1-2.6 321.2 321.2 0 0 1 -45.9-21.9 1.9 1.9 0 0 1 -.2-3.1c3.1-2.3 6.2-4.7 9.1-7.1a1.8 1.8 0 0 1 1.9-.3c96.2 43.9 200.4 43.9 295.5 0a1.8 1.8 0 0 1 1.9 .2c2.9 2.4 6 4.9 9.1 7.2a1.9 1.9 0 0 1 -.2 3.1 301.4 301.4 0 0 1 -45.9 21.8 1.9 1.9 0 0 0 -1 2.6 391.1 391.1 0 0 0 30 48.8 1.9 1.9 0 0 0 2.1 .7A486 486 0 0 0 610.7 405.7a1.9 1.9 0 0 0 .8-1.4C623.7 277.6 590.9 167.5 524.5 69.8zM222.5 337.6c-29 0-52.8-26.6-52.8-59.2S193.1 219.1 222.5 219.1c29.7 0 53.3 26.8 52.8 59.2C275.3 311 251.9 337.6 222.5 337.6zm195.4 0c-29 0-52.8-26.6-52.8-59.2S388.4 219.1 417.9 219.1c29.7 0 53.3 26.8 52.8 59.2C470.7 311 447.5 337.6 417.9 337.6z"
